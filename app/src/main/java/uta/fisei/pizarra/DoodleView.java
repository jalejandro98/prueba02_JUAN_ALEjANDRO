...
public class DoodleView extends View {
    ...
    public void onSizeChanged(int w, int h, int oldW, int oldH) {
        ...
        bitmap.eraseColor(drawingBackgroundColor);
    }
    ...
    private void touchMoved(MotionEvent event) {
        ...
        int widthMultiplier = (int) (pressure * 10) ;
    ...
    public void printImage() {
        ...
        try {
            ...
            fos.flush();
            fos.close();
            Toast.makeText(getContext(), "Captura de pantalla guardada en: " + filePath, Toast.LENGTH_LONG).show();
        } catch (IOException e) {
            e.printStackTrace();
            Toast.makeText(getContext(), "Error al imprimir el dibujo", Toast.LENGTH_SHORT).show();
        }
    }
    /**
    public void printImage() {
        if (PrintManagerCompat.from(getContext()).isPrintSupported()) {
            PrintDocumentAdapter printManager = new PrintDocumentAdapter() {
                @Override
